...
import { getWorkflow, updateWorkflow } from "@/app/lib/openSpecterApi";
...
import type { ColumnConfig, OpenSpecterWorkflow } from "@/app/components/shared/types";
import {
    BUILT_IN_IDS,
    BUILT_IN_WORKFLOWS,
...
export default function WorkflowDetailPage({ params }: Props) {
    ...
    const [workflow, setWorkflow] = useState<OpenSpecterWorkflow | null>(null);
                                            ...
                                            {!readOnly && (
                                                <div className="w-8 shrink-0 flex justify-end">
                                                    <button
                                                        ...
                                                        className="p-1 text-gray-300 hover:text-muted-foreground transition-colors"
                                                    >

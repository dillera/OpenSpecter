...
import type { TabularReview, OpenSpecterProject } from "@/app/components/shared/types";
        ...
        <div className="flex-1 overflow-y-auto bg-white">
            ...
            <div className="flex items-center justify-between gap-6 px-8 py-4">
                <div className="min-w-0">
                    ...
                    <p
                        data-testid="tabular-reviews-page-description"
                        className="mt-1 max-w-2xl text-sm leading-5 text-muted-foreground"
                    >
                        Compare documents and extract structured answers across columns.
                    </p>
                </div>
                <div className="flex items-center gap-2">
                    ...
                    <Button
                        type="button"
                        data-testid="tabular-reviews-create-button"
                        onClick={() => setNewTROpen(true)}
                        disabled={creating}
                        className="h-9 rounded-full bg-gray-950 px-4 font-space-grotesk text-sm font-[520] text-white shadow-[0_8px_20px_rgba(2,6,23,0.08)] transition-[background-color,transform,box-shadow] duration-150 hover:bg-gray-800 hover:shadow-[0_10px_24px_rgba(2,6,23,0.12)] active:scale-[0.98] disabled:opacity-50 focus-visible:ring-2 focus-visible:ring-ring/35"
                    >
                        {creating ? (
            ...
            <div className="w-full overflow-x-auto">
                ...
                {loading ? (
                    ...
                    <EmptyState
                        icon={activeTab === "all" && !projectFilter ? "tabular" : "search"}
                        title={
                            activeTab === "all" && !projectFilter
                                ? "Create your first tabular review"
                                : "No reviews found"
                        }
                        description={
                            activeTab === "all" && !projectFilter
                                ? "Extract structured answers from document sets into a review table built for legal analysis."
                                : "Adjust your filters or create a new review when you are ready to extract document data."
                        }
                        actionLabel={
                            activeTab === "all" && !projectFilter
                                ? "Create new"
                        ...
                        loading={creating}
                        actionTestId="tabular-empty-create-new-button"
                    />
                ) : (
                    <div>
                        {filtered.map((review) => {

...
import { generateTabularColumnPrompt } from "@/app/lib/openSpecterApi";
                ...
                <form onSubmit={handleSubmit} className="flex flex-col min-h-0 flex-1">
                    ...
                    <div className="px-6 pt-3 pb-5 overflow-y-auto flex-1">
                        ...
                        <textarea
                            ...
                            placeholder="Write the analysis prompt — describe what Open Specter should extract from each document for this column…"
                    ...
                    <div className="flex items-center justify-between border-t border-gray-100 px-6 py-4">
                        <button
                            type="button"
                            onClick={onDelete}
                            className="rounded-lg px-4 py-2 text-sm text-muted-foreground hover:bg-muted/50 transition-colors"
                        >
                            Delete
                        </button>

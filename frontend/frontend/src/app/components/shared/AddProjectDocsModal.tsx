...
import { getProject, uploadProjectDocument } from "@/app/lib/openSpecterApi";
...
interface Props {
    open: boolean;
    onClose: () => void;
    onSelect: (documents: OpenSpecterDocument[]) => void;
    breadcrumb: string[];
    projectId: string;
...
export function AddProjectDocsModal({
    ...
    const [docs, setDocs] = useState<OpenSpecterDocument[]>([]);

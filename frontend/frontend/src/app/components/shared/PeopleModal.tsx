...
import type { ProjectPeople } from "@/app/lib/openSpecterApi";
...
/**
 * Roster of every Open Specter member with access to the project, with controls to
                                        ...
                                        {entry.role === "member" &&
                                            onSharedWithChange && (
                                                <button
                                                    ...
                                                    disabled={busy !== null}
                                                    title="Remove access"
                                                    className="self-center inline-flex items-center gap-1 rounded px-2 py-1 text-xs text-gray-500 hover:bg-muted/50 hover:text-foreground disabled:opacity-50"
                                                >
                                                    {isRemoving && (

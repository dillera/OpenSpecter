...
import { getDocumentUrl } from "@/app/lib/openSpecterApi";
import type { OpenSpecterDocument } from "./types";

interface Props {
    doc: OpenSpecterDocument | null;
    /** Optional specific version to display. Only honoured for DOCX. */
    versionId?: string | null;
    /** Optional label suffix for the header (e.g. "V3"). */
    versionLabel?: string | null;
    onClose: () => void;
    onDelete?: (doc: OpenSpecterDocument) => void;
}
                    ...
                    <div className="flex items-center gap-1 shrink-0">
                        ...
                        {onDelete && (
                            <button
                                ...
                                className="flex items-center justify-center w-6 h-6 rounded hover:bg-muted/50 text-gray-400 hover:text-muted-foreground transition-colors"
                            >

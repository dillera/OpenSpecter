...
interface Props {
    ...
    handleChat: (message: OpenSpecterMessage) => Promise<string | null>;
    cancel: () => void;
}
...
export function ChatView({
    ...
    const openCitation = useCallback(
        (citation: OpenSpecterCitationAnnotation) => {
            upsertTab({
                kind: "citation",
    ...
    const openEditor = useCallback(
        (ann: OpenSpecterEditAnnotation, filename: string) => {
            upsertTab({
                kind: "edit",
                id: ann.document_id,
    ...
    return (
        <div className="h-full w-full flex relative">
            ...
            <div className="flex flex-col h-full flex-1 relative">
                ...
                >
                    <div className="w-full max-w-4xl mx-auto px-4 pb-2 md:px-6">
                        <div className="w-full rounded-t-[20px] bg-white pb-1">
                            <ChatInput
                                onSubmit={handleChat}
                                onCancel={cancel}
                        ...
                        <p
                            ...
                            data-testid="assistant-chat-ai-disclaimer"
                        >

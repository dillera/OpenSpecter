...
interface Props {
    open: boolean;
    onClose: () => void;
    onSelect: (documents: OpenSpecterDocument[], projectId?: string) => void;
    breadcrumb: string[];
...
export function AddDocumentsModal({
    ...
    const [extraUploadedDocs, setExtraUploadedDocs] = useState<OpenSpecterDocument[]>([]);
    ...
    async function handleDelete(ids: string[]) {
        ...
        const docsById = new Map<string, OpenSpecterDocument>();
        for (const d of [
            ...standaloneDocuments,
            ...extraUploadedDocs,
            ...projects.flatMap((p) => p.documents ?? []),

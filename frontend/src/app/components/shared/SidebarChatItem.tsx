...
import type { OpenSpecterChat } from "@/app/components/shared/types";
            ...
            {isRenaming ? (
                <div className="flex items-center w-full px-2 py-1">
                    ...
                    <button
                        ...
                        className="ml-1.5 py-2 hover:bg-gray-200 rounded text-foreground"
                    >
                        <Check className="h-3 w-3" />
                    </button>
                    <button
                        onClick={handleRenameCancel}
                        className="ml-1 py-2 hover:bg-gray-200 rounded text-foreground"
                    >
                        <X className="h-3 w-3" />
                    </button>
                </div>

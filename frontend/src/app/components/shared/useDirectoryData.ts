...
import { getProject, listProjects, listStandaloneDocuments } from "@/app/lib/openSpecterApi";
import type { OpenSpecterDocument, OpenSpecterProject } from "./types";

const CACHE_TTL_MS = 30_000;

interface DirectoryCache {
    standaloneDocuments: OpenSpecterDocument[];
...
export function useDirectoryData(enabled: boolean) {
    ...
    const [standaloneDocuments, setStandaloneDocuments] = useState<OpenSpecterDocument[]>([]);

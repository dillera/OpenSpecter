...
import { createWorkflow, updateWorkflow } from "@/app/lib/openSpecterApi";
...
interface Props {
    open: boolean;
    onClose: () => void;
    onCreated: (workflow: OpenSpecterWorkflow) => void;
    editWorkflow?: OpenSpecterWorkflow;
    onUpdated?: (workflow: OpenSpecterWorkflow) => void;
}

...
import type { OpenSpecterDocument, OpenSpecterProject, OpenSpecterWorkflow } from "../shared/types";
import {
    getProject,
    listProjects,
...
export function AddNewTRModal({
    ...
    const [projectDocs, setProjectDocs] = useState<OpenSpecterDocument[]>([]);
    const [loadingDocs, setLoadingDocs] = useState(false);

    // Full directory (when underProject is false)
    const [standaloneDocs, setStandaloneDocs] = useState<OpenSpecterDocument[]>([]);
    const [directoryProjects, setDirectoryProjects] = useState<OpenSpecterProject[]>(
        [],
    );
    ...
    // Workflow templates
    const [workflows, setWorkflows] = useState<OpenSpecterWorkflow[]>([]);
    ...
    const directoryFolders = isProjectMode
        ...
        : underProject
          ? []
          : directoryProjects;
    const flatProjectDocs: OpenSpecterDocument[] =

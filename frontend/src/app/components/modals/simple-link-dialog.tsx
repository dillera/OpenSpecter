                ...
                <div className="relative bg-white rounded-2xl shadow-2xl p-6">
                    ...
                    <div className="space-y-4">
                        ...
                        <button
                            ...
                            className="w-full flex items-center justify-center gap-2 bg-foreground hover:bg-foreground text-white py-2.5 px-4 rounded-lg transition-colors font-medium"
                        >
                            {linkCopied ? (
                                <>

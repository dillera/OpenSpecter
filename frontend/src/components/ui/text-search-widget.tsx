            ...
            <div className="flex items-center gap-1 p-1">
                <div className="flex-1 relative">
                    <Input
                        ...
                        className="h-8 text-sm w-full pr-[80px] rounded-sm border-gray-200 bg-gray-100/50 focus-visible:ring-0 focus-visible:border-foreground placeholder:text-gray-500"
                        onKeyDown={(e) => {
                            if (e.key === "Escape") {
                                onClose();
                                onSearchChange("");
